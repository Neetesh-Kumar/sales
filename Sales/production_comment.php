...
$connection = mysqli_connect("localhost","root","");
    ...
    $pro_comment_order="";
    $date_time="";
    $query = "select * from production_comment where order_number = '$_GET[on]'";
...
<html lang="en">
  ...
  <body>
    ...
    $query_run = mysqli_query($connection,$query);
        ...
        <input type="text" class=" form-control m-2" name="pro_name" value="<?php echo $pro_name;?>" readonly>
            <?php           
        }
    ?>    
     </div>
    ...
    $query_run = mysqli_query($connection,$query);
        ...
        <input type="text" class=" form-control m-2" name="pro_comment_order" value="<?php echo $pro_comment_order;?>" readonly>
            <?php                          
        }
    ?>
     </div>
        ...
        while($row = mysqli_fetch_assoc($query_run)){        
            ...
            <div class="row mt-2">
              <div class="col-md-6">
                ...
                <a href="../Production/<?php echo $pro_comment_pdf;?>" target="blank"><button class="form-control btn-sm btn btn-outline-dark" > View</button> </a>
              </div>
              <div class="col-md-6">
