          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Edit Sales Profile</h4>
                    <p class="card-description"> Edit Data </p>
                    <form class="forms-sample" method="post">
                      <div class="form-group">
                        <label for="exampleInputUsername1">Username</label>
                        <input type="text" name="sales_name" class="form-control" value="<?php echo $sales_name;?>"   required="">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Email address</label>
                        <input type="email" name="sales_email" class="form-control"value="<?php echo $sales_email;?>"  required="">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Password</label>
                        <input type="text" name="sales_password" class="form-control"  value="<?php echo $sales_password;?>">
                      </div>
...
<?php
	if(isset($_POST['update'])){
        $connection = mysqli_connect("localhost","root","");
        $db = mysqli_select_db($connection,"crm");
        $query = "update sales set sales_name='$_POST[sales_name]',sales_email='$_POST[sales_email]',sales_password='$_POST[sales_password]'";
        $query_run = mysqli_query($connection,$query);
