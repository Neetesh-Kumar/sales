...
$connection = mysqli_connect("localhost","root","");
    ...
    $sales_comment_order="";
    $date_time="";
    $query = "select * from sales_comment where order_number = '$_GET[se]'";
  ...
  <body>
    ...
    $query_run = mysqli_query($connection,$query);
        while($row = mysqli_fetch_assoc($query_run)){        
            ...
            ?>      
        <!-- <p><?php echo $sales_name;?></p> -->
        <input type="text" class=" form-control m-2" name="sales_name" value="<?php echo $sales_name;?>" readonly>
            <?php           
        }
    ?>    
     </div>
    ...
    $query_run = mysqli_query($connection,$query);
        while($row = mysqli_fetch_assoc($query_run)){                         
            $sales_comment_order = $row['sales_comment_order'];
            ?>                       
        <!-- <p><?php echo $sales_comment_order;?></p> -->
        <input type="text" class=" form-control m-2" name="sales_comment_order" value="<?php echo $sales_comment_order;?>" readonly>
            <?php                          
        }
    ?>
     </div>
    ...
    $query_run = mysqli_query($connection,$query);
        while($row = mysqli_fetch_assoc($query_run)){        
            $sales_comment_pdf = $row['sales_comment_pdf'];
            ?> 
            <div class="row mt-2">
              <div class="col-md-6">

                <a href="<?php echo $sales_comment_pdf;?>" target="blank"><button class="form-control btn-sm btn btn-outline-dark" > View</button> </a>
              </div>
              <div class="col-md-6">
    ...
    ?>    
     ...
     <a href="view_comment.php?cid=ORD-0001"><button class="btn btn-danger">Back</button></a>
