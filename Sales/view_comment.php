...
$connection = mysqli_connect("localhost","root","");
    ...
    $db = mysqli_select_db($connection,"crm_database-36332e55");
    $order_number="";
    $pro_employee_name="";
    $comment_order="";
...
<html lang="en">
  ...
  <body>
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="navbar-brand-wrapper d-flex align-items-center">
          <a class="navbar-brand brand-logo" href="sales_dashboard.php">
                <img src="images/logo.png" alt="logo" class="logo-dark" style="width: calc(336px - 169px);max-width: 197%;height: 97px; margin: auto;vertical-align: middle; " />
          </a>
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-md-10 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h1 class="card-title">Production Employee Order Comments</h1>
                    <div class="row pt-4">
    ...
    $query_run = mysqli_query($connection,$query);
        ...
        <input type="text" class=" form-control m-2" name="order_number" value="<?php echo $order_number;?>" readonly>
            <?php          
        }
    ?>  
    </div>
        ...
        while($row = mysqli_fetch_assoc($query_run)){        
            ...
            <div class="row mt-2">
              ...
              <div class="col-md-6">
                ...
                <a href="comment.php?sid=<?php echo $row['order_number'];?>"><button class=" form-control btn-sm btn btn-primary">Add Comment</button></a>
              </div>
            </div>     
            <?php           
        }
    ?>    
     ...
     <a href="production_comment.php?on=<?php echo $order_number;?>"><button class="btn btn-outline-primary ml-5">View Production Comment</button></a>
