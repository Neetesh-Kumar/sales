      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="col-md-12 shadow p-4 mb-4 bg-white rounded">
            <!-- <h1 class="pt-2">All Employee List</h1> -->
                ...
                <button type="button" class="btn btn-dark float-right "><a href="add_lead.php" style="color:white; text-decoration:none">Add New Lead</a></button>
</div>
            ...
            <table id="table_id" class="display table  table-bordered table-striped  text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="edit_leads.php?lid=<?php echo $row['lead_id'];?>" class="edit" title="Edit"  style="text-decoration: none;color: blue;"><i class="icon-pencil">&#xE254;</i></a>
