...
// $pro_employee_name="";
// $comment_order="";
$query = "select * from comment_order where order_number = '$_GET[sid]'";
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                ...
                <li class="nav-item"> <a  href="add_invoice.php" class="nav-link" >Add New Invoice</a></li>
                  <li class="nav-item"> <a class="nav-link" href="all_invoice">All Invoice List</a></li>
                </ul>
              </div>
            </li>
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="sales_id" class="form-control" value="<?php echo $_SESSION['sales_id'];?>"  readonly>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputUsername1">Employee Name</label>
                        <input type="text" name="sales_name" class="form-control" value="<?php echo $_SESSION['sales_name'];?>"  readonly>
                      </div>
                      </div>
 
                      <div class="form-group">
                <label for="exampleFormControlTextarea1">Add File</label>
             <input type="file" class="form-control" name="sales_comment_pdf" id="sales_comment_pdf">
            </div>
                <div class="form-group">
                <label for="exampleFormControlTextarea1">Comment</label>
                <textarea class="form-control" id="sales_comment_order" name="sales_comment_order" id="exampleFormControlTextarea1" value="<?php echo $discription_order; ?>" rows="5"></textarea>
            </div>
            

            <button type="submit" name="login" class="btn btn-primary mr-2" href="all_order.php">Send Comment</button>
            <a href="view_sales_comment.php?se=<?php echo $order_number;?>" class="info btn btn-outline-primary ml-5" title="Info"  style="text-decoration: none;" >View Comment</a>
...
<?php
    ...
    $date_time=$date;
    move_uploaded_file($_FILES["sales_comment_pdf"]["tmp_name"],"sales_comment_pdf/" . $_FILES["sales_comment_pdf"]["name"]);
    $file="sales_comment_pdf/".$_FILES["sales_comment_pdf"]["name"];
  
    $query = "INSERT into sales_comment values(null,'$_POST[order_number]','$_POST[sales_id]','$_POST[sales_name]','$date_time','$file','$_POST[sales_comment_order]')";
    $query_run = mysqli_query($connection,$query);
