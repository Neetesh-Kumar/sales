<?php
  ...
  $sales_id = "";
	...
	$sales_email = "";
	$sales_password = "";
	$query = "select * from sales where sales_email = '$_SESSION[sales_email]'";
  ...
  <body>
    ...
    <tbody>
        <tr>
            ...
            <td>
            <a href="edit_profile.php?pid=<?php echo $row['sales_id'];?>" class="edit" title="Edit"  style="text-decoration: none;color: blue;" ><i class="icon-pencil">&#xE254;</i></a>
            </td>
        </tr>
