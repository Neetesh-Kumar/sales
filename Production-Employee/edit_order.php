        ...
        <div class="main-panel">
          <div class="content-wrapper">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="invoice_status" value="<?php echo $invoice_status;?>" onchange="showDiv('hidden_div', this)" required>
            ...
            <div class="form-group">
				...
				<input type="file" name="pdf_order" id="pdf_order" class="form-control" value="<?php echo $pdf_order; ?>"  >
			</div>
...
<?php
	...
	$file="pdf_order/".$_FILES["pdf_order"]["name"];
		$query = "update sales_order set invoice_status = '$_POST[invoice_status]',pdf_order='$file',discription_order='$_POST[discription_order]' where order_id = $_GET[oid]";
		$query_run = mysqli_query($connection,$query);
