...
$query = "select * from sales_order  where order_id = $_GET[cid]";
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="pro_employee_id" class="form-control" value="<?php echo $_SESSION['pro_employee_id'];?>"  readonly>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputUsername1">Employee Name</label>
                        <input type="text" name="pro_employee_name" class="form-control" value="<?php echo $_SESSION['pro_employee_name'];?>"  readonly>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputUsername1">Date Time</label>
                        <input type="date" name="date_time" class="form-control"  readonly>
                      </div>
                      </div>
 
                      <div class="form-group">
                <label for="exampleFormControlTextarea1">Add File</label>
             <input type="file" class="form-control" name="comment_pdf" id="comment_pdf">
            </div>
                <div class="form-group">
                <label for="exampleFormControlTextarea1">Comment</label>
                <textarea class="form-control" id="comment_order" name="comment_order" id="exampleFormControlTextarea1" value="<?php echo $discription_order; ?>" rows="5"></textarea>
            </div>
            

            <button type="submit" name="login" class="btn btn-primary mr-2" href="all_order.php">Send Comment</button>
            <a href="view_comment.php?pid=<?php echo $order_number;?>" class="info btn btn-outline-primary ml-5" title="Info"  style="text-decoration: none;" >View Comment</a>
...
<?php
    ...
    $query = "INSERT into comment_order values(null,'$_POST[order_number]','$_POST[pro_employee_id]','$_POST[pro_employee_name]','$date_time','$file','$_POST[comment_order]')";
    $query_run = mysqli_query($connection,$query);
