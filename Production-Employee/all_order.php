...
$employee_id = $_SESSION['pro_employee_id'];
// SQL Query Builder..

$query = "SELECT send_order.*, sales_order.*
FROM sales_order
LEFT JOIN send_order
ON sales_order.order_id = send_order.order_id
WHERE send_order.send_employee_id = $employee_id
GROUP BY send_order.order_id";
            ...
            <table id="table_id" class="display  table table-striped table-bordered text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['lead_number'];?></td>
                           ...
                           ?> 
                            ...
                            <td><?php echo $row['pdf_order'];?></td>
                            <td><a href="comment.php?cid=<?php echo $row['order_id'];?>" class="comment" title="Comment"  style="text-decoration: none;color: blue;" ><button class="btn btn-dark">Comment</button></a></td>
                            <td>
