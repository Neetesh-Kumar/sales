<?php
	...
	$query = "select * from production_employee where pro_employee_id = $_GET[pid]";
          ...
          <ul class="navbar-nav navbar-nav-right ml-auto">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
              <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <img class="img-xs rounded-circle ml-2" src="images/faces/face8.jpg" alt="Profile image"> <span class="font-weight-normal"><?php echo $_SESSION['pro_name'];?> </span></a>
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Edit Production Employee</h4>
                    <p class="card-description"> Edit Employee Data</p>
                    <form class="forms-sample" method="post">
                      <div class="form-group">
                        <label for="exampleInputUsername1">Username</label>
                        <input type="text" name="pro_employee_name" class="form-control" value="<?php echo $pro_employee_name;?>"   required="">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Email address</label>
                        <input type="email" name="pro_employee_email" class="form-control"value="<?php echo $pro_employee_email;?>"  required="">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Password</label>
                        <input type="text" name="pro_employee_password" class="form-control"  value="<?php echo $pro_employee_password;?>">
                      </div>
                      <div class="form-group">
                        <label for="department">Department</label>
                        <select class="form-control currency-list" name="pro_employee_department" value="<?php echo $pro_employee_department;?>" required>
                        <option >Maths</option>
                      ...
                      <button type="submit" name="update" class="btn btn-primary mr-2" href="all_employee.php">Update</button>
...
<?php
	if(isset($_POST['update'])){
        $connection = mysqli_connect("localhost","root","");
        $db = mysqli_select_db($connection,"crm");
        $query = "update production_employee set pro_employee_name='$_POST[pro_employee_name]',pro_employee_email='$_POST[pro_employee_email]',pro_employee_password='$_POST[pro_employee_password]',pro_employee_department='$_POST[pro_employee_department]' where pro_employee_id = $_GET[pid]";
        $query_run = mysqli_query($connection,$query);
         echo "<script>location.href='all_employee.php'</script>";
	}
?>
