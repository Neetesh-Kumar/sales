...
$connection = mysqli_connect("localhost","root","");
    ...
    // $sales_comment_pdf="";
    $sales_comment_order="";
    $query = "select * from sales_comment where order_number = '$_GET[sc]'";
...
<div class="main-panel">
        ...
        while($row = mysqli_fetch_assoc($query_run)){        
            ...
            <div class="row mt-2">
              <div class="col-md-6">
                ...
                <a href="../Sales/<?php echo $sales_comment_pdf;?>" target="blank"><button class="form-control btn-sm btn btn-outline-dark" > View</button> </a>
              </div>
              <div class="col-md-6">
    ...
    ?>    
     ...
     <a href="view_comment.php?pid=ORD-0001"><button class="btn btn-danger">Back</button></a>
