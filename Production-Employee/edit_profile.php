<?php
	...
	$query = "select * from production_employee where pro_employee_email = '$_SESSION[pro_employee_email]'";
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Edit Production Employee Profile</h4>
                    ...
                    <form class="forms-sample" method="post">
                      ...
                      <button type="submit" name="update" class="btn btn-primary mr-2" href="view_profile.php">Update</button>
...
<?php
	if(isset($_POST['update'])){
        $connection = mysqli_connect("localhost","root","");
        $db = mysqli_select_db($connection,"crm");
        $query = "update production_employee set pro_employee_name='$_POST[pro_employee_name]',pro_employee_email='$_POST[pro_employee_email]',pro_employee_password='$_POST[pro_employee_password]'";
        $query_run = mysqli_query($connection,$query);
