<?php
	...
	$pro_email = "";
	$pro_password = "";
	$query = "select * from production where pro_email = '$_SESSION[pro_email]'";
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Edit ProductionProfile</h4>
                    <p class="card-description"> EditProfileData</p>
                    <form class="forms-sample" method="post">
                      <div class="form-group">
                        <label for="exampleInputUsername1">Username</label>
                        <input type="text" name="pro_name" class="form-control" value="<?php echo $pro_name;?>"   required="">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Email address</label>
                        <input type="email" name="pro_email" class="form-control"value="<?php echo $pro_email;?>"  required="">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Password</label>
                        <input type="text" name="pro_password" class="form-control"  value="<?php echo $pro_password;?>">
                      </div>
...
<?php
	if(isset($_POST['update'])){
        $connection = mysqli_connect("localhost","root","");
        $db = mysqli_select_db($connection,"crm");
        $query = "update production set pro_name='$_POST[pro_name]',pro_email='$_POST[pro_email]',pro_password='$_POST[pro_password]'";
        $query_run = mysqli_query($connection,$query);
