...
$connection = mysqli_connect("localhost","root","");
    ...
    $pro_comment_order="";
    $date_time="";
    $query = "select * from production_comment where order_number = '$_GET[oid]'";
        ...
        while($row = mysqli_fetch_assoc($query_run)){        
            ...
            <div class="row mt-2">
              <div class="col-md-6">
                ...
                <a href="<?php echo $pro_comment_pdf;?>" target="blank"><button class="form-control btn-sm btn btn-outline-dark" > View</button> </a>
              </div>
              <div class="col-md-6">
