...
$connection = mysqli_connect("localhost","root","");
    ...
    // $pro_comment_pdf="";
    $sales_comment_order="";
    $query = "select * from sales_comment where order_number = '$_GET[on]'";
...
<html lang="en">
  ...
  <body>
    ...
    $query_run = mysqli_query($connection,$query);
        ...
        <input type="text" class=" form-control m-2" name="pro_comment_order" value="<?php echo $sales_comment_order;?>" readonly>
            <?php                          
        }
    ?>
     </div>
