  ...
  <body style="background-color:#ecf0f4;">
    ...
    <div class="row">
        <!-- <div class="col-md-12 shadow p-4 mb-4 bg-white rounded"> -->
           ...
           <!-- <button type="button" class="btn btn-dark float-right " data-toggle="modal" data-target="#exampleModal">Add Employee</button> -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="create_account.php" method="post" class="fr">
          <div class="form-group">
            <label for="text">Employee Name</label>
              <input type="text" name="pro_employee_name" class="form-control" placeholder="Employee Name" required>
          </div>
          <div class="form-group">
            <label for="text">Employee Email</label>
              <input type="email" name="pro_employee_email" class="form-control" placeholder="Employee Email" required>
          </div>
          <div class="form-group">
            <label for="text">Employee Password</label>
              <input type="password" name="pro_employee_password" class="form-control" placeholder="Employee Password" required>
          </div>
         
            <div class="form-group">
            <label for="text">Department</label>
            <select class="form-control currency-list" name="pro_employee_department" required>
			<option >Maths</option>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="login" class="btn btn-dark">Create Account</button>
		</form>
      </div>
    </div>
  </div>
                ...
                <div class="row pt-1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="edit_pro_employee.php?pid=<?php echo $row['pro_employee_id'];?>" class="info" title="info"  style="text-decoration: none;color: blue;" ><i class="icon-info">&#xE254;</i></a>
