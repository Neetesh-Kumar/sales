          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">View Production Employee</h4>
                    <p class="card-description"> Edit Employee Data</p>
                    <form class="forms-sample" method="post">
                      <div class="form-group">
                        <label for="exampleInputUsername1">Username</label>
                        <input type="text" name="pro_employee_name" class="form-control" value="<?php echo $pro_employee_name;?>"   readonly>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Email address</label>
                        <input type="email" name="pro_employee_email" class="form-control"value="<?php echo $pro_employee_email;?>"  readonly>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Password</label>
                        <input type="text" name="pro_employee_password" class="form-control"  value="<?php echo $pro_employee_password;?>" readonly>
                      </div>
                      <div class="form-group">
                        <label for="department">Department</label>
                        <input type="text" name="pro_employee_department" class="form-control"  value="<?php echo $pro_employee_department;?>" readonly>
                      </div>
                      <button type="submit" name="back" class="btn btn-danger mr-2"><a href="all_employee.php" style="color:white; text-decoration:none;">Back</a></button>
