<?php
				...
				if(isset($_POST['login'])){
					...
					$query = "select * from all_employee_data where employe_email = '$_POST[employe_email]'";
					$query_run = mysqli_query($connection,$query);
					while($row = mysqli_fetch_assoc($query_run)){
						if($row['employe_email'] == $_POST['employe_email']){
							if($row['employe_password'] == $_POST['employe_password']){
								$_SESSION['employe_name'] = $row['employe_name'];
								$_SESSION['employe_email'] = $row['employe_email'];
                                $_SESSION['employe_id'] = $row['employe_id'];
                                 $_SESSION['employee_number'] = $row['employee_number'];
                                $_SESSION['employe_designation'] = $row['employe_designation'];
    ...
    <nav class="navbar navbar-expand-lg" style="color:#fff;  background: #eb5242;">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
                ...
                <li class="nav-item">
					<a class="nav-link" href="index.php" style="color:#fff; ">Employee Login</a>
				</li>
			</ul>
		</div>
	</nav><br>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Employee</strong> Login Form</h1>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Login to our Employee Panel</h3>
                            ...
                            <form action="" method="post" class="fr">
				                <div class="form-group">
					                ...
					                <input type="text" name="employe_email" class="form-control" placeholder="Employee ID" required>
				                </div>
				                <div class="form-group">
				
					                <input type="password" name="employe_password" class="form-control" placeholder="Enter Your Password" required>
				                </div>
