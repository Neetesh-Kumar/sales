            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic1">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="all_order.php">All Task List</a></li>
                </ul>
              </div>
            </li>
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Edit Empl,oyee Profile</h4>
                    <p class="card-description"> Edit Profile Data</p>
                    <form class="forms-sample" method="post">
                      <div class="form-group">
                        <label for="exampleInputUsername1">Username</label>
                        <input type="text" name="employe_name" class="form-control" value="<?php echo $employe_name;?>"   required="">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Email address</label>
                        <input type="email" name="employe_email" class="form-control"value="<?php echo $employe_email;?>"  required="">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Password</label>
                        <input type="text" name="employe_password" class="form-control"  value="<?php echo $employe_password;?>">
                      </div>
...
<?php
	if(isset($_POST['update'])){
        $connection = mysqli_connect("localhost","root","");
        $db = mysqli_select_db($connection,"crm");
        $query = "update all_employee_data set employe_name='$_POST[employe_name]',employe_email='$_POST[employe_email]',employe_password='$_POST[employe_password]'";
        $query_run = mysqli_query($connection,$query);
