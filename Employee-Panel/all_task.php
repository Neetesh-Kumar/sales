...
$query = "SELECT send_task.*, add_task.*
FROM add_task
LEFT JOIN send_task
ON add_task.task_id = send_task.task_id
WHERE send_task.send_employee_id = $employe_id
GROUP BY send_task.task_id";
    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="row">
            ...
            <table id="table_id" class="display table table-bordered table-striped  text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['dua_date'];?></td>
                            
                            <td>
                            <?php
                              if($row['status']==0){
                                echo'<P><button class="btn btn-danger"     width: 131px;>Incomplete</button><P>';
                               
                              }else if($row['status']==1){
                                echo'<P><button class="btn btn-success"     width: 131px;>Completed</button><P>';
                              }
                              else{
                                echo'<P><button class="btn btn-primary"     width: 131px;>Progress</button><P>';
                              }
                           ?> 
                            </td>
                            <!-- <td><?php echo $row['link'];?></td> -->
                            <td><?php echo $row['pdf_task'];?></td>
                            <td><?php echo $row['discription_task'];?></td>
                            
                            <td>
                            <a href="edit_task.php?oid=<?php echo $row['task_id'];?>" class="edit" title="Edit"  style="text-decoration: none;color: blue;" ><i class="icon-pencil">&#xE254;</i></a>
                            <a href="view_task.php?lid=<?php echo $row['task_id'];?>" class="info" title="info"  style="text-decoration: none;color: blue;"><i class="icon-info">&#xE254;</i></a> 
                            <a href="../Sales/<?php echo $row['pdf_order'];?>" class="dowload" title="download"  style="text-decoration: none;color: blue;" download><i class="icon-cloud-download">&#xE254;</i></a>  
                          </td>
                        </tr>
                        <?php } ?>
