    ...
    <nav class="navbar navbar-expand-lg" style="color:#fff;  background: #eb5242;">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="nav-item">
					<a class="nav-link" href="Sales/index.php" style="color:#fff; ">Sales Login</a>
				</li>
				<li class="nav-item">
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Login to our Admin Panel</h3>
                            ...
                            <form action="" method="post" class="fr">
				                <div class="form-group">
					                ...
					                <input type="text" name="email" class="form-control" placeholder="Admin ID" required>
				                </div>
				                <div class="form-group">
