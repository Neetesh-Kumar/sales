                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12 shadow p-4 mb-4 bg-white rounded">
                                ...
                                <button type="button" class="btn btn-dark float-right "><a href="add_task.php"
                                        style="color:white; text-decoration:none">Add New Task</a></button>
                            ...
                            <div class="container-fluid pt-2">
                                <div class="row">
                                    <div class="col-md-12 shadow p-3 mb-5 bg-white rounded">
                                        <table id="table_id"
                                            class="display table  table-bordered table-striped  text-center">
                        ...
                        $pdf_task="";
                        $discription_task="";
                        $query = "select * from add_task left join all_employee_data on add_task.assign_to = all_employee_data.employe_id";
                        	$query_run = mysqli_query($connection,$query);
                            while($row = mysqli_fetch_assoc($query_run)){
                                $task_id = $row['task_id'];
                                $task_number = $row['task_number'];
                                $task = $row['task'];
                                $assign_to = $row['employe_name'];
                                $project = $row['project'];
                        ...
                        ?>
                           ...
                           ?>
                                                    ...
                                                    <td><?php echo $pdf_task;?></td>
                                                    <td><?php echo $discription_task;?></td>

                                                    <td>
                                                        <a href="edit_task.php?oid=<?php echo $row['task_id'];?>"
                                                        ...
                                                        <a href="<?php echo $row['pdf_task'];?>" class="dowload"
                                                            title="download" style="text-decoration: none;color: blue;"
                                                            download><i class="icon-cloud-download">&#xE254;</i></a>
                                                        <a href="send_task.php?sid=<?php echo $row['task_id'];?>"
