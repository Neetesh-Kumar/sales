    ...
    $query_run = mysqli_query($connection,$query);
        while($row = mysqli_fetch_assoc($query_run)){        
            ...
            ?>
                                            ...
                                            <input type="text" class=" form-control m-2" name="sales_name"
                                                value="<?php echo $sales_name;?>" readonly>
                                            <?php           
        }
    ?>
                                        </div>
    ...
    $query_run = mysqli_query($connection,$query);
        while($row = mysqli_fetch_assoc($query_run)){                         
            ...
            ?>
                                            ...
                                            <input type="text" class=" form-control m-2" name="sales_comment_order"
                                                value="<?php echo $sales_comment_order;?>" readonly>
                                            <?php                          
        }
    ?>
                                        </div>
            ...
            ?>
                                            <div class="row mt-2">
                                                <div class="col-md-6">
                                                    ...
                                                    <a href="../Sales/<?php echo $sales_comment_pdf;?>"
                                                        target="blank"><button
