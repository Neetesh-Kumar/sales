<?php
  ...
  $pro_password = "";
	$pro_id = "";
	$query = "select * from production where pro_id = $_GET[pid]";
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="pro_email" class="form-control"
                                                value="<?php echo $pro_email;?>" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Password</label>
                                            <input type="text" name="pro_password" class="form-control"
                                                value="<?php echo $pro_password;?>">
                                        </div>
...
<?php
	if(isset($_POST['update'])){
		$connection = mysqli_connect("localhost","root","");
		$db = mysqli_select_db($connection,"crm");
		$query = "update production set pro_name = '$_POST[pro_name]', pro_email = '$_POST[pro_email]', pro_password = '$_POST[pro_password]' where pro_id = $_GET[pid]";
		$query_run = mysqli_query($connection,$query);
