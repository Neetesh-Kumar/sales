                                        ...
                                        <form action="create_lead.php" method="post" class="fr">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="lead_number" class="form-control"
                                                    id="lead_number" value="<?php echo $lead_number; ?>" readonly>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="lead_mobile" class="form-control"
                                                    placeholder="Lead Mobile Numer" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="text">Lead Website</label>
                                                <input type="url" name="lead_website" class="form-control"
                                                    placeholder="Lead Website" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="text">Lead Discription</label>
                                                <textarea name="lead_comment" class="form-control"
                                                    placeholder="Lead Comment" required></textarea>
                                            </div>
