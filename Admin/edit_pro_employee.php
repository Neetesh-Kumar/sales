                                    ...
                                    <form class="forms-sample" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="pro_employee_name" class="form-control"
                                                value="<?php echo $pro_employee_name;?>" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Email address</label>
                                            <input type="email" name="pro_employee_email" class="form-control"
                                                value="<?php echo $pro_employee_email;?>" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Password</label>
                                            <input type="text" name="pro_employee_password" class="form-control"
                                                value="<?php echo $pro_employee_password;?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="department">Department</label>
                                            <select class="form-control currency-list" name="pro_employee_department"
                                                value="<?php echo $pro_employee_department;?>" required>
                                                <option>Maths</option>
                                        ...
                                        <button type="submit" name="update" class="btn btn-primary mr-2"
                                            href="all_employee.php">Update</button>
...
<?php
	if(isset($_POST['update'])){
        ...
        $query_run = mysqli_query($connection,$query);
         echo "<script>location.href='all_pro_employee.php'</script>";
	}
?>