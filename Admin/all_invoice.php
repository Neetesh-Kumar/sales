                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12 shadow p-4 mb-4 bg-white rounded">
                                ...
                                <button type="button" class="btn btn-dark float-right "><a href="add_invoice.php"
                                        style="color:white; text-decoration:none">Add New Invoice</a></button>
                            </div>
                        ...
                        ?>
                           ...
                           ?>
                                                    ...
                                                    <td><?php echo $proof_pdf;?></td>
                                                    <td><?php echo $discription_invoice;?></td>
                                                    <td><button class="btn btn-dark"><a
                                                                href="add_order.php?eid=<?php echo $row['invoice_id'];?>"
                                                                style="color:white; text-decoration:none;">Create
                                                                Order</a></button></td>
                                                    <td>
                                                        <a href="edit_invoice_status.php?tid=<?php echo $row['invoice_id'];?>"
                                                            class="edit" title="Edit"
                                                            style="text-decoration: none;color: blue;"><i
                                                                class="icon-pencil">&#xE254;</i></a>

                                                        <a href="edit_invoice.php?iid=<?php echo $row['invoice_id'];?>"
