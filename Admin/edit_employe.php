...
$query = "select * from all_employee_data where employe_id = $_GET[lid]";
...
$employe_designation = $row['employe_designation'];
}
?>
                                    ...
                                    <form class="forms-sample" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="employee_number" class="form-control"
                                                value="<?php echo $employee_number;?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="name">Name </label>
                                            <input type="text" name="employe_name" class="form-control"
                                                value="<?php echo $employe_name;?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="email">Email</label>
                                            <input type="email" name="employe_email" class="form-control"
                                                value="<?php echo $employe_email;?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="url">Website</label>
                                            <input type="url" name="employe_password" class="form-control"
                                                value="<?php echo $employe_password;?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="comment">Comment</label>
                                            <input type="text" name="employe_designation" class="form-control"
                                                value="<?php echo $employe_designation;?>">
                                        </div>
                                        <button type="submit" name="update" class="btn btn-primary mr-2"
                                            href="all_leads.php">Update</button>
...
<?php
	if(isset($_POST['update'])){
		$connection = mysqli_connect("localhost","root","");
		$db = mysqli_select_db($connection,"crm");
		$query = "update all_employee_data set employee_number = '$_POST[employee_number]', employe_name = '$_POST[employe_name]', employe_email = '$_POST[employe_email]', employe_password = '$_POST[employe_password]', employe_designation = '$_POST[employe_designation]' where employe_id = $_GET[lid]";
		$query_run = mysqli_query($connection,$query);
		// header("location:all_employee.php");
    echo "<script>location.href='all_add_employee.php'</script>";
	}
?>