...
$lead_id="";
$lead_number="";
$query = "select * from lead  where lead_id = $_GET[eid]";
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <!-- <li class="nav-item"> <a href="add_invoice.php" class="nav-link">Add New Invoice</a> -->
                    </li>
                        ...
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-8">
                                <div class="wizard">
                                    ...
                                    <form role="form" action="create_invoice.php" class="login-box" method="post"
                                            ...
                                            <div class="tab-pane active" role="tabpanel" id="step1">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="lead_number" class="form-control"
                                                                value="<?php echo $lead_number;?>"
                                                                style="background-color:#e9ecef;" readonly>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <div class="input-group-prepend">
                                                                    <span
                                                                        class="input-group-text input-group-addon currency-symbol">$</span>
                                                                </div>
                                                                <input type="text" name="invoice_amount"
                                                                    class="form-control currency-amount input-group-addon currency-symbol"
                                                                    aria-label="Amount (to the nearest dollar)"
                                                                    id="inlineFormInputGroup" placeholder="0.00"
                                                                    size="8" required>
                                                                <div class="input-group-append">
                                                                    <span
                                                                        class="input-group-text input-group-addon currency-addon"
                                                                        style="height: 46px;">
                                                                        <select class="currency-selector" style=""
                                                                            id="ddlselect">
                                                                            <!-- <option value="1" data-symbol="$"
                                                                                data-placeholder="0.00" selected>USD
                                                                            </option>
                                                                            <option value="2" data-symbol="€"
                                                                                data-placeholder="0.00">EUR</option>
                                                                            <option value="3" data-symbol="£"
                                                                                data-placeholder="0.00">GBP</option> -->
                                                                            <option value="3" data-symbol="Rs."
                                                                                data-placeholder="0.00">PKR</option>
                                                ...
                                                <ul class="list-inline pull-right">
                                                    <li><button type="button"
                                                            class="default-btn next-step text-white">Continue to
                                                            next step</button></li>
                                                </ul>
                                            </div>
                                            <div class="tab-pane" role="tabpanel" id="step2">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="myselect" class="form-control currency-list"
                                                                name="invoice_status"
                                                    ...
                                                    <div id="hidden_div">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="file" name="proof_pdf" id="proof_pdf"
                                                                    class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label
                                                                    for="exampleFormControlTextarea1">Discription</label>
                                                                <textarea class="form-control" id="discription"
                                                                    name="discription_invoice" rows="4"
                                                                    cols="100"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <ul class="list-inline pull-right">
                                                    ...
                                                    <li><button type="submit" class="btn btn-primary"
                                                            name="login">Create Invoice</button></li>
                                                </ul>
                                            </div>
