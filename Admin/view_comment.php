...
<body>
                ...
                $query_run = mysqli_query($connection,$query);
                    while($row = mysqli_fetch_assoc($query_run)){        
                        ...
                        ?>
                                            ...
                                            <input type="text" class=" form-control m-2" name="pro_employee_name"
                                                value="<?php echo $pro_employee_name;?>" readonly>
                                            <?php           
                    }
                ?>
                                        </div>
                ...
                $query_run = mysqli_query($connection,$query);
                    while($row = mysqli_fetch_assoc($query_run)){                         
                        ...
                        ?>
                                            ...
                                            <input type="text" class=" form-control m-2" name="comment_order"
                                                value="<?php echo $comment_order;?>" readonly>
                                            <?php                          
                    }
                ?>
                                        </div>
    ...
    $query_run = mysqli_query($connection,$query);
        while($row = mysqli_fetch_assoc($query_run)){        
            ...
            ?>
                                            <a href="../Production-Employee/<?php echo $comment_pdf;?>"
                                                class="form-control m-2" target="blank"
                                                style="text-decoration: none;color: black;"><?php echo $comment_pdf;?></a>
                                            <?php           
        }
    ?>
                                        </div>
                                        <a href="all_order.php"><button class="btn btn-danger">Back</button></a>
                                        <a href="sales_comment.php?sc=<?php echo $order_number;?>"><button
                                                class="btn btn-outline-primary ml-5">View Sales Comment</button></a>
                                        <a href="production_comment.php?pc=<?php echo $order_number;?>"><button
                                                class="btn btn-outline-primary ml-5">View Production
                                                Comment</button></a>
                                    </div>
