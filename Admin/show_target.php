                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 shadow p-4 mb-4 bg-white rounded">
                            ...
                            <button type="button" class="btn btn-dark float-right "><a href="add_target.php"
                                    style="color:white; text-decoration:none">Add New Target</a></button>
                        </div>
                                    ...
                                    <table id="table_id"
                                        ...
                                        <tbody>
                                            <?php
                                                    ...
                                                    ?>
                                            <tr>
                                                <td><?php echo $target_id;?></td>
                                                <td><?php echo $monthly_amount;?></td>
                                                <td><?php echo $sales_id;?></td>
                                                <td><?php echo $start_date;?></td>
                                                <td><?php echo $end_date;?></td>
                                                 <!-- <td>   <a href="edit_leads.php?lid=<?php echo $row['lead_id'];?>"
