                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description"> Edit Lead Data </p>
                                    <form class="forms-sample" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="lead_name" class="form-control"
                                                value="<?php echo $lead_name;?>" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="email">Email</label>
                                            <input type="email" name="lead_email" class="form-control"
                                                value="<?php echo $lead_email;?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="number">Number</label>
                                            <input type="number" name="lead_mobile" class="form-control"
                                                value="<?php echo $lead_mobile;?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="url">Website</label>
                                            <input type="url" name="lead_website" class="form-control"
                                                value="<?php echo $lead_website;?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="comment">Discription</label>
                                            <input type="text" name="lead_comment" class="form-control"
                                                value="<?php echo $lead_comment;?>">
                                        </div>
