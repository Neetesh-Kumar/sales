                    ...
                    <div class="container-fluid">
                            ...
                            <div class="container-fluid pt-2" width="80%">
                                <div class="row">
                                    <div class="col-md-12 shadow p-3 mb-5 bg-white rounded">
                                        <table id="table_id"
                                            class="display table table-responsive table-striped table-bordered text-center">
                        ...
                        ?>
                           ...
                           ?>
                                                    ...
                                                    <td>
                                                        <a href="view_comment.php?cid=<?php echo $row['order_number'];?>"
                                                            class="info" title="Info"
                                                            style="text-decoration: none;color: blue;"><button
                                                                class="btn btn-primary">View Comment</button></a>
                                                    </td>
                                                    <td>

                                                        <a href="edit_order.php?oid=<?php echo $row['order_id'];?>"
                                                        ...
                                                        <a href="<?php echo $row['pdf_order'];?>" class="dowload"
