                            ...
                            <div class="col-md-6 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-description"> Add Target </p>
                                        <form action="create_target.php" method="post" class="fr">
                                            <!-- <div class="form-group">
                                                <label for="text">Monthly Amount</label>
                                                <input type="text" name="monthly_amount" class="form-control"
                                                    id="monthly_amount" value="">
                                            </div> -->
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                $connection = mysqli_connect("localhost","root","");
                                                $db = mysqli_select_db($connection,"crm");
                                                $query = "select sales_id, sales_name from sales";
                                                $query_run = mysqli_query($connection,$query);
                                                while($row = mysqli_fetch_assoc($query_run)){
                                                    extract($row);
                                                    ?>
                                                    <option value="<?php echo $sales_id; ?>"><?php echo $sales_name;?></option>
                                                    <?php
                                                }
                                            ?>
					                        </select>
