<?php
  ...
  $sales_password = "";
	$sales_id = "";
	$query = "select * from sales where sales_id = $_GET[sid]";
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Edit Sales Employee</h4>
                                    ...
                                    <form class="forms-sample" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sales_password" class="form-control"
                                                value="<?php echo $sales_password;?>">
                                        </div>
...
<?php
	if(isset($_POST['update'])){
		$connection = mysqli_connect("localhost","root","");
		$db = mysqli_select_db($connection,"crm");
		$query = "update sales set sales_name = '$_POST[sales_name]', sales_email = '$_POST[sales_email]', sales_password = '$_POST[sales_password]' where sales_id = $_GET[sid]";
		$query_run = mysqli_query($connection,$query);
