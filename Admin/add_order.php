        ...
        <div class="container-fluid page-body-wrapper">
                                        ...
                                        <form action="create_order.php" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="order_number" class="form-control"
                                                    id="order_number" value="<?php echo $order_number; ?>" readonly>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="sales_person" class="form-control"
                                                    value="<?php echo $_SESSION['sales_name'];?>" readonly>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="color" class="form-control currency-list"
                                                    name="invoice_status" readonly>
            ...
            <option class="green" value="2" >Progress</option> -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="pdf_order" class="form-control"
                                                    id="customFile" />
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label" for="customFile">Discription</label>
                                                <textarea class="form-control" id="discription" name="discription_order"
                                                    id="exampleFormControlTextarea1"
                                                    value="<?php echo $discription_order; ?>" rows="5"></textarea>
                                            </div>
                                    </div>
