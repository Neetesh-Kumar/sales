...
$sale_startdate="";
$sale_enddate="";
$query = "select * from sales_order  where order_id = $_GET[oid]";
                                    ...
                                    <form class="forms-sample" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="invoice_status"
                                                value="<?php echo $invoice_status;?>" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="sale_startdate" class="form-control"
                                                value="<?php echo $sale_startdate;?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="text">Delivery Date</label>
                                            <input type="date" name="sale_enddate" class="form-control"
                                                value="<?php echo $sale_enddate;?>">
                                        </div>

                                        <button type="submit" name="update" class="btn btn-primary mr-2"
                                            href="all_order.php">Update</button>
...
<?php
	if(isset($_POST['update'])){
		$connection = mysqli_connect("localhost","root","");
		$db = mysqli_select_db($connection,"crm");
		$query = "update sales_order set order_number = '$_POST[order_number]',lead_number = '$_POST[lead_number]',invoice_number = '$_POST[invoice_number]', sales_person = '$_POST[sales_person]', course_name = '$_POST[course_name]',invoice_status = '$_POST[invoice_status]',link = '$_POST[link]',sale_startdate = '$_POST[sale_startdate]',sale_enddate = '$_POST[sale_enddate]' where order_id = $_GET[oid]";
		$query_run = mysqli_query($connection,$query);
		// header("location:all_employee.php");
    echo "<script>location.href='all_order.php'</script>";
	}
?>