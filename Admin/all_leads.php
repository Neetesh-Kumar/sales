                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 shadow p-4 mb-4 bg-white rounded">
                            ...
                            <button type="button" class="btn btn-dark float-right "><a href="add_lead.php"
                                    style="color:white; text-decoration:none">Add New Lead</a></button>
                        </div>
                        ...
                        <div class="container pt-2">
                            <div class="row">
                                <div class="col-md-12 shadow p-3 mb-5 bg-white rounded">
                                    <table id="table_id"
                                        class="display table table-responsive table-bordered table-striped  text-center">
                        ...
                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $lead_website;?></td>
                                                <td><?php echo $lead_comment;?></td>
                                                <td><button class="btn btn-dark"><a
                                                            href="add_invoice.php?eid=<?php echo $row['lead_id'];?>"
                                                            style="color:white; text-decoration:none;">Create
                                                            Invoice</a></button></td>
                                                <td>
                                                    <a href="edit_leads.php?lid=<?php echo $row['lead_id'];?>"
                                                        class="edit" title="Edit"
                                                        style="text-decoration: none;color: blue;"><i
                                                            class="icon-pencil">&#xE254;</i></a>
                                                    <!-- <a href="delete_lead.php?aid=<?php echo $row['lead_id'];?>" class="delete" title="Delete" data-toggle="tooltip" style="text-decoration: none;color: red;"><i class="icon-trash">&#xE872;</i></a> -->
                                                </td>
                                            </tr>
                                            <?php
                            }
