...
<?php
 $last_nmbr = '';
 $query = "select * from all_employee_data order by employee_number desc limit 1";
 
 $stmt = $connection->query($query);
   if(mysqli_num_rows($stmt) > 0) {
       if ($row = mysqli_fetch_assoc($stmt)) {
           $last_nmbr = $row['employee_number'];
           $last_nmbr = substr($last_nmbr, 4, 8);//separating numeric part
           $last_nmbr = $last_nmbr + 1;//Incrementing numeric part
           $last_nmbr = "EMP-" . sprintf('%04s', $last_nmbr);//concatenating incremented value
           $employee_number = $last_nmbr;
       }
   } 
   else {
       $last_nmbr = "EMP-0001";
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body bg-white">
                                                <form action="create_all_employee.php" method="post" class="fr">
                                                    <div class="form-group">
                                                        <label for="text">Employee Number</label>
                                                        <input type="text" name="employee_number" id="employee_number"
                                                            value="<?php echo $employee_number;?>" class="form-control"
                                                            readonly>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" name="employe_password"
                    ...
                    <div class="row pt-1">
                        <div class="col-md-12 shadow p-3 mb-5 bg-white rounded">
                          ...
                          $db = mysqli_select_db($connection,"crm");
                            ...
                            $employe_password="";
                            $employe_designation="";
                          $query = "select * from all_employee_data ";
                        ...
                        ?>
                                    <tr>
                                        ...
                                        <td><?php echo $employe_designation;?></td>
                                        <td>
                                            <a href="edit_employe.php?lid=<?php echo $row['employe_id'];?>" class="edit"
