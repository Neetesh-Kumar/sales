                                    ...
                                    <form class="forms-sample" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="invoice_amount" class="form-control "
                                                value="<?php echo $invoice_amount;?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="text">Status</label>
                                            <input type="text" name="invoice_status" class="form-control "
                                                value="<?php echo $invoice_status;?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Add File Attachment</label>
                                            <!-- <input name="pdf_order" class="form-control"  value="<?php echo $pdf_order;?>" /> -->
                                            <a href="../Sales/<?php echo $proof_pdf;?>" class="form-control"
                                                target="blank"
                                                style="text-decoration: none;color: black;"><?php echo $proof_pdf;?></a>
                                        </div>
                                        <div class="form-group">
                                            <label for="discription">Discription</label>
                                            <textarea name="discription_invoice" id="discription_invoice"
                                                class="form-control" value="<?Php echo $discription_invoice;?>"
                                                readonly></textarea>
                                        </div>

                                        <button type="submit" name="back" class="btn btn-danger mr-2"><a
                                                href="all_invoice.php"
