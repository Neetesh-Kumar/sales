                                    ...
                                    <form action="" method="post" id="myForm" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="myselect" class="form-control currency-list"
                                                name="invoice_status" value="<?php echo $invoice_status; ?>"
                                        ...
                                        <div id="hidden_div">
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="proof_pdf" id="proof_pdf" class="form-control"
                                                    value="<?php echo $proof_pdf; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleFormControlTextarea1">Discription</label>
                                                <textarea class="form-control" id="discription"
                                                    name="discription_invoice" id="exampleFormControlTextarea1"
                                                    value="<?php echo $discription_invoice;?>" rows="5"></textarea>
                                            </div>
                                        </div>
