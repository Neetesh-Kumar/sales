...
<?php
	if(isset($_POST['update'])){
		...
		$query = "update add_task set task_number = '$_POST[task_number]',task = '$_POST[task]',project = '$_POST[project]', dua_date = '$_POST[dua_date]', status = '$_POST[status]',pdf_task = '$file',discription_task = '$_POST[discription_task]' where task_id = $_GET[oid]";
		$query_run = mysqli_query($connection,$query);
